...
function buildFeatureVersions(t: (key: string) => string): Record<string, BentoTile[]> {
  return {
    'v0.4.0': [
      ...
      {
        id: 'multi-sheet',
        span: 'xl:col-start-11 xl:col-span-2 xl:row-start-1',
        icon: LayersIcon,
      ...
      {
        id: 'command',
        span: 'xl:col-start-9 xl:col-span-2 xl:row-start-3',
        icon: KeyboardIcon,
      ...
      {
        id: 'virtualized',
        span: 'xl:col-start-1 xl:col-span-4 xl:row-start-1 xl:row-span-2',
        tone: 'plain',
        icon: BoltIcon,
      ...
      {
        id: 'filters',
        span: 'xl:col-start-9 xl:col-span-2 xl:row-start-1',
        icon: FilterIcon,
      ...
      {
        id: 'sticky',
        span: 'xl:col-start-1 xl:col-span-2 xl:row-start-3',
        icon: PinIcon,
      ...
      {
        id: 'format',
        span: 'xl:col-start-11 xl:col-span-2 xl:row-start-3',
        icon: PaletteIcon,
      ...
      {
        id: 'find',
        span: 'xl:col-start-3 xl:col-span-2 xl:row-start-3',
        icon: SearchIcon,
    ...
    'v0.5.0': [
      ...
      {
        id: 'resize',
        span: 'xl:col-start-1 xl:col-span-2 xl:row-start-2',
        icon: ResizeIcon,
      ...
      {
        id: 'formula',
        span: 'xl:col-start-3 xl:col-span-2 xl:row-start-2',
        tone: 'tint',
        icon: FormulaIcon,
      ...
      {
        id: 'autoUpdate',
        span: 'xl:col-start-1 xl:col-span-3 xl:row-start-4',
        tone: 'accent',
        icon: AutoUpdateIcon,
      ...
      {
        id: 'command',
        span: 'xl:col-start-4 xl:col-span-3 xl:row-start-4',
        icon: KeyboardIcon,
        title: t('bento.command.title'),
      ...
      {
        id: 'filters',
        span: 'xl:col-start-7 xl:col-span-3 xl:row-start-4',
        icon: FilterIcon,
        title: t('bento.filters.title'),
        description: t('bento.filters.description'),
      },
      {
        id: 'copy',
        span: 'xl:col-start-10 xl:col-span-3 xl:row-start-4',
        icon: CopyIcon,
        title: t('bento.copy.title'),
        description: t('bento.copy.description'),
      },
